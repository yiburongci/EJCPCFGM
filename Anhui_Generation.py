"""
Anhui Province - Electricity Generation
...
TRAIN_DATA = [1443.85, 1635.35, 1767.50, 1970.04, 2033.91, 2062.00, 2252.69, 2456.28, 2734.49, 2886.67, 2808.98, 3083.39]
TEST_DATA = [3298.77, 3549.45, 3863.46]
...
def main():
    print("Anhui - Electricity Generation | Optimal N Test")
    ...
    # Save to CSV
    filepath = os.path.join(OUTPUT_DIR, 'Anhui_Generation_Results.csv')
