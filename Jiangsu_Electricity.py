"""
Jiangsu Province - Electricity Consumption
...
TRAIN_DATA = [3864.00, 4281.62, 4580.90, 4956.60, 5012.54, 5114.70, 5458.95, 5807.89, 6128.27, 6264.00, 6374.00, 7101.00]
TEST_DATA = [7400.00, 7833.00, 8486.93]
...
def main():
    print("Jiangsu - Electricity Consumption | Optimal N Test")
    ...
    # Save to CSV
    filepath = os.path.join(OUTPUT_DIR, 'Jiangsu_Electricity_Results.csv')
