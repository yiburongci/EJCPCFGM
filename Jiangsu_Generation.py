"""
Jiangsu Province - Electricity Generation
...
TRAIN_DATA = [3359.18, 3762.50, 3928.40, 4320.68, 4347.57, 4361.00, 4709.37, 4914.74, 5085.08, 5166.43, 5217.54, 5968.89]
TEST_DATA = [6077.31, 6390.53, 6807.37]
...
def main():
    print("Jiangsu - Electricity Generation | Optimal N Test")
    ...
    # Save to CSV
    filepath = os.path.join(OUTPUT_DIR, 'Jiangsu_Generation_Results.csv')
